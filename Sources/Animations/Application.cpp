...
void Application::UpdateCameraBuffers()
{
    ...
    m_DxShader->UpdateCameraConstantBuffer(camera_buffer);
}
...
bool Application::SDLInit()
{
    ...
    m_SdlWindow = SDL_CreateWindow("DirectX - Model Loading", SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED, 800, 600, window_flags);
