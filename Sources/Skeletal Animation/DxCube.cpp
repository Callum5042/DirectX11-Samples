...
DX::Cube::Cube(DX::Renderer* renderer) : m_DxRenderer(renderer)
{
...
void DX::Cube::CreateVertexBuffer()
{
	...
	vertex_buffer_desc.ByteWidth = static_cast<UINT>(sizeof(Vertex1) * vertices.size());
...
void DX::Cube::CreateIndexBuffer()
{
	auto d3dDevice = m_DxRenderer->GetDevice();
...
void DX::Cube::Render()
{
	...
	UINT vertex_stride = sizeof(Vertex1);
